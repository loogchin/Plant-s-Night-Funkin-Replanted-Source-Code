	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			case 'gf':
				...
				addOffset("singLEFT", 0, -48);
				addOffset("singDOWN", 0, -45);
				addOffset('hairBlow', 0, 3);
				addOffset('hairFall', 0, -9);

				addOffset('scared', -3, -38);
			...
			case 'dad':
				...
				animation.addByPrefix('crazy', 'Dad Crazy', 24);
				...
				addOffset("idle", 0, 1);
				addOffset("crazy", 50, 110);
				addOffset("singUP", -22, 39);
				addOffset("singRIGHT", -33, 26);
				addOffset("singDOWN", 13, -4);
				addOffset("singLEFT", 95, 9);
			...
			case 'bfwink':
				...
				frames = tex;
				animation.addByPrefix('wink', 'BF wink', 24, false);
