...
class StoryMenuState extends MusicBeatState
{
	...
	var weekData:Array<Dynamic> = [
		['Grasswalk'],
		['Crazy-Dave', 'Wabby-Wabbo', 'Zombies-on-your-lawn'],
	...
	var weekNames:Array<String> = [
		"Solar Flare & Green Shadow",
		"Crazy Dave",
		"Chompzilla, Peashooter & an unwanted guest",
		"NightCap & and the mushroom farm",
		"Rose & Hngg... Kernel",
		"Major Sweetie and the rest of the gang",
		"Senpai???"
	];
